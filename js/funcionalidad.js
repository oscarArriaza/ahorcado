...
(
    ...
    function()
    {
        ...
        function principal()
        {
            ...
            let h1Bienvenida=document.getElementById("h1Bienvenida");
            ...
            let h1NumeroDeErrores=document.getElementById("h1NumeroDeErrores");
        ...
        function mostrarInformacion(resultado)
        {
            ...
            for (let i = 0; i < capitales.length; i++)
            {
                if(i===indiceDeLaPalabra)
                {
                    ...
                    h1NombreDeLaCapital.textContent=capitales[i].nombre;
                    imagenDeLaCapital.src=capitales[i].imagen;
                    parrafoInformacion.textContent=capitales[i].informacion;
                }
            }
            generarBotonCambiarNombre();
            generarBotonVolverAJugar();
            let botonVolverAJugar=document.getElementById("volverAJugar");
            botonVolverAJugar.addEventListener
            (
                "click",
                function()
                {
                    ejecutarProcesoPosteriorAClickearBotonVolverAJugar();
                }
            );
        }
        ...
        function generarBotonCambiarNombre()
        {
            ...
            let botonCambiarNombre=document.createElement("button");
            botonCambiarNombre.setAttribute("type", "button");
            botonCambiarNombre.setAttribute("value", "Cambiar nombre");
            botonCambiarNombre.textContent="Cambiar nombre";
            botonCambiarNombre.className="btn btn-success";
            botonCambiarNombre.id="cambiarNombre";
            enlaceIndex.appendChild(botonCambiarNombre);
        }
        ...
        function generarBotonVolverAJugar()
        {
            ...
            botonVolverAJugar.className="btn btn-success ms-4";
            botonVolverAJugar.id="volverAJugar";
            divInformacionFooter.appendChild(botonVolverAJugar);
        }
        function ejecutarProcesoPosteriorAClickearBotonVolverAJugar()
        {
            guardarEstadoDeLaPartida("reiniciada");
